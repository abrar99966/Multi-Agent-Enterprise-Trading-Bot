...
// One-shot fetch of intraday/daily candles + the latest quote for a symbol.
...
export function useCandles(symbol, { range = '1d', interval = '5m', enabled = true, timeoutMs = 12000 } = {}) {
  ...
  }, [symbol, range, interval, enabled, timeoutMs, nonce]);
